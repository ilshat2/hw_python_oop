...
class InfoMessage:
    ...
    def get_message(self) -> str:
        self.wow = '' if self.calories > 0 else ' '
        info: str = (f'Тип тренировки: {self.training_type}; '
                     f'Длительность:{self.duration: .3f} ч.; '
                     f'Дистанция:{self.distance: .3f} км; '
                     f'Ср. скорость:{self.speed: .3f} км/ч; '
                     f'Потрачено ккал:{self.wow}{self.calories: .3f}.')
        return info
...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        """Получить количество затраченных калорий во время
        спортивной ходьбы.
        """
...
def read_package(workout_type: str, data: list) -> Union[Training, str]:
    ...
    try:
        ...
        return 'Одна ошибка и ты ошибся.'
